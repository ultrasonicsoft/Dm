        ...
        private void btnRegister_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                using (IE explore = new IE())
                {
                    ...
                    var oneMonthUrl = explore.Link(Find.ByUrl("http://uploaded.net/register/choice/PRM-M1"));
                    oneMonthUrl.ClickNoWait();
                    ...
                    //explore.TextField(Find.ById("free-mail")).Value = ConfigurationManager.AppSettings["email"];
                    //explore.TextField(Find.ById("free-firstname")).Value = ConfigurationManager.AppSettings["firstName"];
                    //explore.TextField(Find.ById("free-lastname")).Value = ConfigurationManager.AppSettings["lastName"];
                    //explore.WaitForComplete();

                    explore.TextField(Find.ById("free-mail")).Value = "jung.ulrich@gmx.net";
                    explore.TextField(Find.ById("free-firstname")).Value = "jung";
                    explore.TextField(Find.ById("free-lastname")).Value = "ulrich";
                    explore.Button(Find.ByClass("register-box-btn")).Click();
                    //explore.WaitForComplete();
                    ...
                    if (frames != null && frames.Count > 0)
                    {
                        ...
                        {
                            loggingInformation.Append("Entering paysafe pin 1: " + paysafePin1 + Environment.NewLine);
                            frames[0].TextField(Find.ById("pinForm:rn01")).Value = paysafePin1;
                            //explore.WaitForComplete();
                        }
                        pinTextField = frames[0].TextField(Find.ById("pinForm:rn02"));
                        if (pinTextField != null)
                        {
                            loggingInformation.Append("Entering paysafe pin 2: " + paysafePin2 + Environment.NewLine);
                            frames[0].TextField(Find.ById("pinForm:rn02")).Value = paysafePin2;
                            //explore.WaitForComplete();
                        }
                        pinTextField = frames[0].TextField(Find.ById("pinForm:rn03"));
                        if (pinTextField != null)
                        {
                            loggingInformation.Append("Entering paysafe pin 3: " + paysafePin3 + Environment.NewLine);
                            frames[0].TextField(Find.ById("pinForm:rn03")).Value = paysafePin3;
                            //explore.WaitForComplete();
                        }
                        pinTextField = frames[0].TextField(Find.ById("pinForm:rn04"));
                        if (pinTextField != null)
                        {
                            loggingInformation.Append("Entering paysafe pin 4: " + paysafePin4 + Environment.NewLine);
                            frames[0].TextField(Find.ById("pinForm:rn04")).Value = paysafePin4;
                            //explore.WaitForComplete();
                        }
                    }
