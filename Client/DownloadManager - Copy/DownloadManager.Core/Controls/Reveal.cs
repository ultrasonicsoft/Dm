...
{
    /// <summary>
    /// NOTE! This control was taken from Bag'o'Tricks, check it at http://bot.codeplex.com/
    /// You can use this only according to the license mentioned at the site!
    /// </summary>
    public class Reveal : Decorator
    {
        ...
        {
            Reveal r = (Reveal)sender;
            bool isExpanded = (bool)e.NewValue;
            if (r.IsLoaded)
            {
                r.SetupAnimation(isExpanded);
            }
            else
            {
                r.AnimationProgress = isExpanded ? 1 : 0;
            }
        }
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            if (Child != null)
            {
                ...
                size.Width = CalculateWidth(size.Width, percent, HorizontalReveal);
                size.Height = CalculateHeight(size.Height, percent, VerticalReveal);
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            if (child != null)
            {
                ...
                double childWidth = Math.Max(finalSize.Width, child.DesiredSize.Width);
